...
import mexicaanseOvenschotel from "../img/mexicaanseOvenschotel.png";
import vegaBurger from "../img/vegaburger.png";

const mexicaanseOvenschotelIngredienten = [
  "2 middelgrote uien",
  "1 teen knoflook",
  "1 vega burger",
...
const mexicaanseOvenschotelBereiding = [
...
class CarouselRecepten extends React.Component {
      ...
      >
        <Link
          to={{
            ...
            state: {
              banner: mexicaanseOvenschotel,
              name: "Mexicaanse ovenschotel met pitttig saus",
              persons: "2",
              cal: "685 Kcal",
              time: "50 min",
              category: "Oven schotel",
              preparation: mexicaanseOvenschotelBereiding,
              ingredients: mexicaanseOvenschotelIngredienten,
            },
          }}
        >
          <RecipeCard
            image={mexicaanseOvenschotel}
            name="Mexicaanse ovenschotel met pitttig saus"
            cal="685 Kcal"
            time="50 min"
          />
...
export default CarouselRecepten;
